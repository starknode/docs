...
```bash cURL
curl --request POST \
  --url https://api.starknode.io/api/yield/deposit \
...
```javascript Node.js
const response = await fetch("https://api.starknode.io/api/yield/deposit", {
  method: "POST",
  headers: {
...
response = requests.post(
    "https://api.starknode.io/api/yield/deposit",
