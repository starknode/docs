...
api: "GET /api/yield/rebalance-opportunities/{symbol}"
...
```bash cURL
curl --request GET \
  --url https://api.starknode.io/api/yield/rebalance-opportunities/USDC \
  --header 'x-api-key: <api_key>'
```

```javascript Node.js
const response = await fetch(
  "https://api.starknode.io/api/yield/rebalance-opportunities/USDC",
